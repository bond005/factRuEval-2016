...
def texts_to_X(texts: List[List[str]], max_sentence_length: int, data_name: str) -> np.ndarray:
            ...
            with tf.Session() as sess:
                ...
                for batch_idx in range(n_batches):
                    ...
                    for text_idx in range(start_pos, end_pos):
                        new_text = copy.copy(texts[text_idx])
                        while len(new_text) < max_sentence_length:
                            new_text.append('')
                        texts_in_batch.append(new_text)
                        lengths_of_texts.append(len(texts[text_idx]))
